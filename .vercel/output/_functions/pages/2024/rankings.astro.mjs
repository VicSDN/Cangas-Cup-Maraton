...
import { $ as $$Goal } from '../../chunks/Goal_PhMmZfBr.mjs';
import { $ as $$YellowCard } from '../../chunks/YellowCard_ag8Gmq0T.mjs';
import { $ as $$RedCard } from '../../chunks/RedCard_Bpi1lrY9.mjs';
...
Tarjetas Amarillas: ${p.yellowCard} </p>`} ${category === "rojas" && renderTemplate`<p class="text-white text-xl">Tarjetas Rojas: ${p.redCard}</p>`} </div>`)} </dialog>`)}` })} ${renderScript($$result, "C:/Users/VicSDNDW/Desktop/Cangas-Cup-Maraton/src/pages/2024/rankings/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/VicSDNDW/Desktop/Cangas-Cup-Maraton/src/pages/2024/rankings/index.astro", undefined);

const $$file = "C:/Users/VicSDNDW/Desktop/Cangas-Cup-Maraton/src/pages/2024/rankings/index.astro";
const $$url = "/2024/rankings";
